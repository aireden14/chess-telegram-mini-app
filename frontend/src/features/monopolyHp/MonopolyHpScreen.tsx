...
// Монополия: Магический мир — настолка с обменами (standalone iframe, без backend).
export function MonopolyHpScreen() {
  ...
  return (
    ...
    <div className="catan-fs" style={{ paddingTop: "var(--safe-top, 0px)" }}>
      <iframe
        ...
        title="Монополия: Магический мир"
        src="/games/monopoly-hp/index.html"
